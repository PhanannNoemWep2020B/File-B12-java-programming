...
public class exercises1 {
	...
	public static void main(String[] args) {
		...
		System.out.println(word3.substring(4) +  keyword + word3);
		...
		for(int i = 0; i < sentence.length(); i++) {
			if(sentence.charAt(i) == key || sentence.charAt(i) =='O') {
				count++;
			}
		}
		...
		if(url.endsWith("/")) {
			System.out.println(url.concat("WEP2020B"));
		}else {
			System.out.println(url.concat("doesn't end with /"));
		}
